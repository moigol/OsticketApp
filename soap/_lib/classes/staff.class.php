     ...
     class ostStaff extends ostSOAP {
        ...
        public function getInfo($username, $password, $staffId) {
            ...
            $info = array(
                ...
                'tzOffset'      => $staff->getTZOffset(),
                'canCreate'     => $staff->canCreateTickets(),
                'canEdit'       => $staff->canEditTickets(),
                'canClose'      => $staff->canCloseTickets(),
                'canDelete'     => $staff->canDeleteTickets(),
                'canReply'      => $staff->canPostReply(),
                'canAssign'     => $staff->canAssignTickets(),
                'canTransfer'   => $staff->canTransferTickets()
            );
